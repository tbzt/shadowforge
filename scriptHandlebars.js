...
function showPriorities() {
    ...
    var priorities = {
        "A": {
            "metatypes": metatype_A_14.map(item => capitalized(item.terms)).join(', ') + " (14), " + metatype_A_13.map(item => capitalized(item.terms)).join(', ') + " (13), " + metatype_A_12.map(item => capitalized(item.terms)).join(', ') + " (12)",
            "attributes": "24",
            "skills": "32",
        ...
        "B": {
            "metatypes": metatype_B_12.map(item => capitalized(item.terms)).join(', ') + " (12), " + metatype_B_11.map(item => capitalized(item.terms)).join(', ') + " (11), " + metatype_B_10.map(item => capitalized(item.terms)).join(', ') + " (10)",
            "attributes": "16",
            "skills": "24",
        ...
        "C": {
            "metatypes": metatype_C_10.map(item => capitalized(item.terms)).join(', ') + " (10), " + metatype_C_9.map(item => capitalized(item.terms)).join(', ') + " (9), " + metatype_C_8.map(item => capitalized(item.terms)).join(', ') + " (8), " + metatype_C_4.map(item => capitalized(item.terms)).join(', ') + " (4)",
            "attributes": "12",
            "skills": "20",
        ...
        "D": {
            "metatypes": metatype_D_5.map(item => capitalized(item.terms)).join(', ') + " (5), " + metatype_D_4.map(item => capitalized(item.terms)).join(', ') + " (4), " + metatype_D_2.map(item => capitalized(item.terms)).join(', ') + " (2)",
            "attributes": "8",
            "skills": "16",
        ...
        "E": {
            "metatypes": metatype_E_1.map(item => capitalized(item.terms)).join(', ') + " (1)",
            "attributes": "2",
            "skills": "10",

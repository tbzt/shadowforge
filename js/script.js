...
$(document).ready(function () {
  const selectors = [
    "#collapseQualities",
    "#collapseRangedWeapons" /* autres sélecteurs ici */,
  ];
    ...
    $(document).on("submit", `#add${capitalized(type)}Form`, function (e) {
      ...
      if (type === "contacts") {
        ...
        characterData.points.contacts.spent =
          characterData.points.contacts.spent + connection + loyalty;
  ...
  if (characterData.spells.length > 0) {
    ...
    spells.forEach(function (spell) {
      ...
      <tr>
          ...
          <td class="type-column">${capitalized(terms[spell.type])}</td>  
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="btn-close btn-close-white" onclick="closeCatalogPanel('${type}')" aria-label="Close"></button>
          </div>
          <div class="modal-body">
          <div class="filters">
...
<option value="${capitalized(terms.rifle)}">${capitalized(terms.rifle)}</option>
...
<option value="${capitalized(terms.taser)}">${capitalized(terms.taser)}</option>
  </select>

const catalogData = {
  qualities: [
    ...
    },
    {
      ...
      description:
        "Les meilleurs vous respectent. Vous avez le potentiel naturel d’être encore meilleur que les meilleurs dans une compétence spécifique. Votre rang maximum pour la compétence sélectionnée est de 10 au lieu de 9 et votre rang de départ maximum est de 7 au lieu de 6. (ldb, 73)",
      type: "positive",
      karmaCost: "12",
    },
    {
    ...
    },
    {
      ...
      description:
        "Des dépôts calcaires se développent sur ou à travers votre peau, ce qui vous rend plus robuste et un peu brut de décoffrage. Littéralement. Vous gagnez 1 niveau d’Armure naturelle (cumulable avec toute autre armure). Vos attaques à mains nues infligent des dommages physiques. (ldb, 74)",
      type: "positive",
      karmaCost: "7",
    },
    {
      key: "Dur à cuire",
      description:
        "Que ce soit grâce à un entraînement mental, à une discipline physique d’automutilation ou simplement parce que vous êtes un véritable dur à cuire, vous encaissez mieux les coups que les autres. Vous bénéficiez d’une remise d’Atout de 1 sur tous vos tests de résistance aux dommages. (ldb, 74)",
      type: "positive",
      karmaCost: "12",
    },
    {
    ...
    },
    {
      key: "M. Tout le Monde",
      description:
        "Vous êtes la personne la moins intéressante du monde. Vous avez une taille moyenne, un poids moyen, une carrure moyenne, vous êtes moyen dans tous les domaines. Rien en vous ne permet de vous différencier des autres, ce qui peut s’avérer extrêmement utile. les personnages subissent un malus de -2 dés à leurs tests de Mémoire (p. 106) pour se rappeler s’ils vous ont déjà vu et le seuil des tests pour remarquer que vous les suivez ou que vous les observez est augmenté de 1. Si vous acquérez un signe distinctif permanent (quelque chose d’évident, un cyberware peu commun, un tatouage unique, ce genre de choses) vous perdez ce trait. Si vous acquérez un signe distinctif temporaire, comme une coiffure extrême, les effets de ce trait sont annulés jusqu’à ce que vous vous débarrassiez de ce signe distinctif. (ldb, 75)",
      type: "positive",
      karmaCost: "8",
    },
    {
    ...
    },
    {
      key: "Robuste",
      description:
        "Vous êtes bâti comme une armoire à glace. Vous pouvez encaisser quelques coups supplémentaires avant d’être neutralisé. Vous avez un nombre de cases supplémentaires sur votre Moniteur de dommages physiques égal à votre rang dans ce trait. (ldb, 76)",
      type: "positive",
      karmaCost: "4",
    },
    {
    ...
    },
    {
      ...
      description:
        "Il peut s’agir d’une allergie aux pollens qui fait couler votre nez et vous fait éternuer ou d’une puissante réaction anaphylactique à l’une de ces rares cacahuètes naturelles. Quoi qu’il en soit, vous subissez une certaine gêne à cause d’une substance du Sixième Monde. Vous ne pouvez pas gagner ou dépenser de l’Atout tant que vous êtes soumis à votre allergène. Pour chaque niveau de sévérité, vous subissez également les effets secondaires indiqués. Vous subissez un malus de -4 à votre réserve de dés pour tout test avec un attribut physique tant que l’allergène vous affecte. (ldb, 76)",
      type: "negative",
      karmaCost: "14",
    },
    {
    ...
    },
    {
      ...
      description:
        "Il peut s’agir d’une allergie aux pollens qui fait couler votre nez et vous fait éternuer ou d’une puissante réaction anaphylactique à l’une de ces rares cacahuètes naturelles. Quoi qu’il en soit, vous subissez une certaine gêne à cause d’une substance du Sixième Monde. Vous ne pouvez pas gagner ou dépenser de l’Atout tant que vous êtes soumis à votre allergène. Pour chaque niveau de sévérité, vous subissez également les effets secondaires indiqués. Vous subissez un malus de -4 à votre réserve de dés pour tout test avec un attribut physique tant que l’allergène vous affecte. Vous subissez également 1 case de dommages physiques auxquels vous ne pouvez pas résister par minute d’exposition à l’allergène. (ldb, 76)",
      type: "negative",
      karmaCost: "17",
    },
    {
    ...
    },
    {
      ...
      description:
        "Il peut s’agir d’une allergie aux pollens qui fait couler votre nez et vous fait éternuer ou d’une puissante réaction anaphylactique à l’une de ces rares cacahuètes naturelles. Quoi qu’il en soit, vous subissez une certaine gêne à cause d’une substance du Sixième Monde. Vous ne pouvez pas gagner ou dépenser de l’Atout tant que vous êtes soumis à votre allergène. Pour chaque niveau de sévérité, vous subissez également les effets secondaires indiqués. Vous subissez un malus de -6 à votre réserve de dés pour toutes vos actions et subissez 1 case de dommages physiques auxquels vous ne pouvez pas résister par 30 secondes d’exposition à l’allergène. (ldb, 76)",
      type: "negative",
      karmaCost: "20",
    },
    {
    ...
    },
    {
      key: "Asocial",
      description:
        "À un moment donné de votre vie, le filtre entre vos pensées et votre bouche a disparu. Vous vous considérez comme étant brutalement honnête, mais les autres ont tendance à vous considérer comme quelqu’un de grossier et d’agressif. Vous ne pouvez pas dépenser de l’Atout sur vos tests utilisant le Charisme. (ldb, 77)",
      type: "negative",
      karmaCost: "6",
    },
    {
    ...
    },
    {
      ...
      description:
        "Il n’en faut pas beaucoup pour vous faire voir trentesix chandelles. Vous n’avez jamais su encaisser les coups. Vous avez une case de dommages étourdissants de moins pour chaque niveau de ce trait jusqu’à un minimum de 2 cases. (ldb, 80)",
      type: "negative",
      karmaCost: "4",
    },
    {
    ...
    },
    {
      ...
      description:
        "Vous avez les nerfs sensibles et une nature globalement douillette. Quelle que soit la raison, vous êtes très affecté par les blessures et l’inconfort. Tous les modificateurs de blessure sont doublés. (ldb, 81)",
      type: "negative",
      karmaCost: "10",
    },
    {
    ...
    },
    {
      ...
      description:
        "lorsque vous prenez (ou obtenez) ce trait, choisissez le sujet de vos Mauvais souvenirs. Lorsque vous êtes forcé de faire face à ce sujet, vous ne pouvez gagner au maximum qu’un seul point d’Atout par tour au lieu de deux. (feuNourri, 124)",
      type: "negative",
      karmaCost: "3",
    },
    {
    ...
    },
    {
      ...
      description:
        "Vous arrivez tout le temps avec au moins quinze minutes de retard à chaque événement prévu. Lorsque l’événement en question est une rencontre avec un employeur potentiel, votre équipe subit un malus de –1 à ses tests de Social contre M. Johnson à cause de votre manque de professionnalisme. (feuNourri, 124)",
      type: "negative",
      karmaCost: "2",
    },
    {
    ...
    },
    {
      ...
      description:
        "Certains professeurs des arcanes proposent des techniques supplémentaires, appelées représentations, à leurs étudiants pour compléter leur apprentissage. Bien que la plupart de ces étudiants, en devenant de plus en plus confiants, se défont petit à petit de ces techniques, d’autres les trouvent rassurantes ou utiles et les gardent. Ce trait est accessible aux mages et adeptes mystiques, mais pas aux adeptes. Le magicien définit une action bien visible ou audible : des gestes, des mots à prononcer, des chants ou autre. Elle devra être réalisée à chaque fois qu’il utilisera ses pouvoirs arcaniques. Sinon, il peut également porter un costume ou une tenue spéciale (ou aucune). L’acte ou l’habit ne peut pas être classique ou insignifiant (ex. : des vêtements débraillés ou particulièrement originaux), il doit éveiller les soupçons des passants, même ceux des ordinaires, et leur indiquer que du mojo est à l’œuvre.  L’autre inconvénient de ce trait, c’est qu’il indique aux ennemis que le magicien est la «personne dangereuse» et si les adversaires suivent la bonne vieille devise «butez le mage en premier», cela le met en danger de mort. Mais malgré ces inconvénients, ce trait lui octroie un avantage : une fois par jour, lorsque le magicien réalise sa représentation en utilisant ses pouvoirs arcaniques, il gagne une remise d’Atout de 1 pour ce test. (voiesOccultes, 111)",
      type: "negative",
      karmaCost: "8",
    },
    {
    ...
    },
    {
      ...
      description:
        "Les étudiants en magie apprennent les techniques standard de leur tradition pour résister à la fatigue qui s’empare d’eux après l’utilisation de leurs pouvoirs arcaniques. Cependant, certains professeurs proposent des entraînements qui répondent aux besoins individuels de leurs élèves et les aident à réduire les effets de la magie plus efficacement. Les magiciens peuvent choisir Logique comme nouvel attribut de tradition. Ils utiliseront cet attribut pour tous les tests de résistance au Drain. (voiesOccultes, 110)",
      type: "positive",
      karmaCost: "7",
    },
    {
      ...
      description:
        "Les étudiants en magie apprennent les techniques standard de leur tradition pour résister à la fatigue qui s’empare d’eux après l’utilisation de leurs pouvoirs arcaniques. Cependant, certains professeurs proposent des entraînements qui répondent aux besoins individuels de leurs élèves et les aident à réduire les effets de la magie plus efficacement. Les magiciens peuvent choisir Intuition comme nouvel attribut de tradition. Ils utiliseront cet attribut pour tous les tests de résistance au Drain. (voiesOccultes, 110)",
      type: "positive",
      karmaCost: "7",
    },
    {
      ...
      description:
        "Les étudiants en magie apprennent les techniques standard de leur tradition pour résister à la fatigue qui s’empare d’eux après l’utilisation de leurs pouvoirs arcaniques. Cependant, certains professeurs proposent des entraînements qui répondent aux besoins individuels de leurs élèves et les aident à réduire les effets de la magie plus efficacement. Les magiciens peuvent choisir Charisme comme nouvel attribut de tradition. Ils utiliseront cet attribut pour tous les tests de résistance au Drain. (voiesOccultes, 110)",
      type: "positive",
      karmaCost: "7",
    },
    {
    ...
    },
    {
      ...
      description:
        "Votre corps s’est particulièrement bien adapté à vos augmentations, ce qui vous permet de réduire le coût en Essence de celles à venir. Pour chaque niveau de ce trait, vous générez 0,1 point d’Essence réservé à l’achat d’aug‑ mentations supplémentaires. Concrètement le «vide d’Essence» ainsi créée n’augmente pas votre score mais est ponctionné en priorité à chaque fois que vous vous faites installer une nouvelle augmentation. (compagnon, 128)",
      type: "positive",
      karmaCost: "2",
    },
    {
      key: "Bravache",
      description:
        "Au diable les Ombres, à vous les feux de la rampe ! Une fois par séance, vous pouvez gagner un point d’Atout pour n’importe quelle action pour peu que vous en profitiez pour frimer un maximum. À chaque utilisation de ce trait, augmentez votre Pression de 1 point. (compagnon, 128)",
      type: "positive",
      karmaCost: "6",
    },
    {
      ...
      description:
        "Vous êtes habitué au Bruit, et vous le trouvez même réconfortant. Quand vous êtes soumis au Bruit, vous bénéficiez d’une remise d’Atout de 1 (avec un coût minimum de 1). Cela ne s’applique qu’aux actions matricielles. Il est possible de réduire le Bruit en partie, mais s’il est totalement annulé ce trait ne s’applique plus. (compagnon, 128)",
      type: "positive",
      karmaCost: "4",
    },
    {
    ...
    },
    {
      ...
      description:
        "Vous n’êtes pas limité à une seule compétence maximi‑ sée lors de la création de personnage. Vous pouvez disposer de deux compétences au rang 6. (compagnon, 129)",
      type: "positive",
      karmaCost: "18",
    },
    {
      ...
      description:
        "Vous avez appris à utiliser des réactifs pour alimenter vos sorts, ce qui réduit vos chances de subir le Drain. Quand vous lancez un sort, vous pouvez dépenser une action mineure pour utiliser des réactifs afin de faciliter vos tests de résistance au Drain. Pour chaque réactif ainsi sacrifié, vous gagnez un dé supplémentaire, avec un maximum égal à votre rang dans la compétence Enchantement (Alchimie). (compagnon, 129)",
      type: "positive",
      karmaCost: "12",
    },
    {
      ...
      description:
        "Vous savez où cacher les choses pour que personne ne les trouve. Si l’objet que vous cherchez à dissimuler n’est pas plus gros qu’un pistolet lourd, son seuil de Dissimulation augmente de 1. Cet effet fonctionne contre les tests de Perception classiques et les senseurs. (compagnon, 129)",
      type: "positive",
      karmaCost: "7",
    },
    {
      key: "Cyborg",
      description:
        "Vous représentez la fusion parfaite entre le métahu‑ main et la machine. Votre corps est capable de recevoir un nombre d’augmentations auxquelles la plupart des gens ne survivraient pas. Vous ne pouvez acquérir ce trait que si votre score d’Essence est de 1 ou moins et que vous possédez déjà 10 niveaux du trait Accoutumance aux augmentations. Comme avec Accoutumance aux augmentations, vous débloquez 0,1 point d’Essence par niveau ; cette réserve est dépensée en priorité lors de l’installation d’augmentations supplémentaires. (compagnon, 129)",
      type: "positive",
      karmaCost: "5",
    },
    {
    ...
    },
    {
      key: "Esprit d’équipe",
      description:
        "Vous faites partie d’une équipe, et vous savez comment veiller sur elle. Vous pouvez dépenser de l’Atout à la place d’un autre personnage, sans surcoût. La dépense peut être partagée ou être à votre seule charge, pour tout bonus ou toute action. La limite d’une seule uti‑ lisation d’Atout par test s’applique néanmoins tou‑ jours, indépendamment de qui s’acquitte du coût. (compagnon, 129)",
      type: "positive",
      karmaCost: "10",
    },
    {
      key: "Focalisé",
      description:
        "Vous êtes entièrement dévoué à votre objectif et rien ne reste sur votre chemin bien longtemps. Avec l’accord et les indications de votre maître de jeu, choisissez un but précis pour votre per‑ sonnage. Lors de tests directement liés à l’accomplisse‑ ment de cet objectif, vous avez toujours la possibilité de remplacer un de vos dés par deux Dés libres. Si vous réussissez à atteindre votre but, vous pouvez vous en fixer un nouveau. Si vous renoncez à l’un de vos objectifs, vous ne pouvez en choisir un autre avant un mois. (compagnon, 129)",
      type: "positive",
      karmaCost: "6",
    },
    {
      key: "Inspirant",
      description:
        "Vous savez motiver les gens pour qu’ils donnent le meilleur d’eux‑mêmes. Au prix d’une action majeure, vous pou‑ vez faire un test d’Influence (Leadership) + Charisme pour aider un autre personnage lors d’un test d’équipe impliquant n’importe quelle compétence. Vous ou le personnage que vous assistez (au choix du joueur) gagnez un point d’Atout. (compagnon, 130)",
      type: "positive",
      karmaCost: "11",
    },
    {
      ...
      description:
        "Votre matière grise s’est accoutumée à l’interface avec votre cyberjack, ce qui améliore ses capacités. Ajoutez 1 point au plus faible des deux attributs matriciels de votre cyberjack. (compagnon, 130)",
      type: "positive",
      karmaCost: "12",
    },
    {
    ...
    },
    {
      key: "Muscles",
      description:
        "Vous savez faire valoir votre impressionnant physique dans vos interactions sociales. Vous pouvez utiliser votre Force au lieu de votre Charisme pour vos tests de compétences so‑ ciales, mais seulement si vous êtes capable de mettre votre physique avantageux en avant. (compagnon, 130)",
      type: "positive",
      karmaCost: "6",
    },
    {
      ...
      description:
        "Comment tirer le meilleur de votre matos électro‑ nique ? En lançant plus de softs ! Vous pouvez lancer un programme sup‑ plémentaire sur n’importe lequel de vos appareils. Quand vous le faites, vous gagnez 1 point d’Atout. (compagnon, 130)",
      type: "positive",
      karmaCost: "10",
    },
    {
      ...
      description:
        "Vous savez comment tirer le maximum de vos augmen‑ tations quand le besoin s’en fait sentir. Quand vous amplifiez une de vos aug‑ mentations (p. 290, SR6), vous pouvez maintenir l’effet pendant un round par niveau de ce trait (au lieu d’être limité à un seul test). Vous devez utiliser le Dé libre pour chaque test impliquant l’attribut amplifié. (compagnon, 131)",
      type: "positive",
      karmaCost: "6",
    },
    {
      ...
      description:
        "Sur une échelle de un à dix, votre cyber est à onze Quand vous amplifiez votre cyberware (p. 290, SR6), gagnez un point d’Atout. Si vous sur‑sollicitez votre augmentation avec une complica‑ tion ou un échec critique, le temps de redémarrage de votre matériel diminue d’un round. (compagnon, 131)",
      type: "positive",
      karmaCost: "7",
    },
    {
    ...
    },
    {
      key: "Polyglotte",
      description:
        "Votre truc à vous, c’est les langues. Vous pouvez apprendre de nouvelles compétences de langues au prix de 2 points de Karma. Améliorer le niveau de vos compétences de langues ne vous coûte que 1 point de Karma. Vous pouvez améliorer vos compétences de langues jusqu’au niveau 4 (Langue maternelle). (compagnon, 131)",
      type: "positive",
      karmaCost: "4",
    },
    {
      ...
      description:
        "Vous maîtrisez rapidement tout art martial que vous apprenez. Vous bénéficiez d’une remise de 2 points de Karma pour apprendre un art martial ou de nou‑ velles techniques (p. 93, Feu Nourri). Vous pouvez combiner plusieurs techniques et arts martiaux lors d’une même période d’entraînement. (compagnon, 131)",
      type: "positive",
      karmaCost: "14",
    },
    {
      ...
      description:
        "Vous n’êtes pas limité à un seul attribut maximisé lors de la création de personnage. Ce trait ne peut être choisi qu’à la créa‑ tion de personnage. Vous pouvez attribuer la valeur maximale pour votre métatype à deux attributs. (compagnon, 131)",
      type: "positive",
      karmaCost: "18",
    },
    {
      ...
      description:
        "Ils peuvent courir et se cacher autant qu’ils veulent, jamais ils ne vous échapperont. Vous gagnez 1 point d’Atout quand vous utilisez la compétence Plein Air (Pistage). (compagnon, 131)",
      type: "positive",
      karmaCost: "6",
    },
    {
    ...
    },
    {
      ...
      description:
        "Pas de chance, les stim patchs provoquent une réaction allergique chez vous. Tant que vous êtes sous l’effet d’un stim patch, vous subissez l’état Désorienté. (compagnon, 131)",
      type: "negative",
      karmaCost: "10",
    },
    {
    ...
    },
    {
      ...
      description:
        "Maîtriser une compétence spécifique ne vous a ja‑ mais emballé. Ce trait ne peut être acquis et ne s’applique que lors de la création de personnage. Vous ne pouvez pas démarrer avec une compétence à son rang de départ maximum. Si vous utilisez les règles de système de parcours de vie, vous devez réduire la compétence maximisée de 1 et assigner ce point à une compétence différente. (compagnon, 131)",
      type: "negative",
      karmaCost: "5",
    },
    {
      key: "Cyber‑psychose",
      description:
        "Vos très nombreuses augmentations ont fait de vous un peu plus qu’un simple métahumain. Dans votre cas, cela se traduit par un certain détachement, parfois perturbé par de brusques explosions d’émotions inappropriées. Pour choisir ce trait votre score d’Essence doit être de 1 ou moins. Effet en jeu : chaque fois que votre ré‑ serve d’Atout atteint zéro, vous commencez à perdre le contact avec votre situation et votre environnement. Soit vous devenez détaché et apathique, soit vous êtes empli d’une émotion intense qui semble sortir de nulle part. Jusqu’à ce que vous regagniez de l’Atout, votre nombre d’actions mineures par round diminue de 1 par niveau de ce trait. Si le niveau de ce dernier est supérieur au nombre d’actions mineures actuellement à votre disposition, votre action majeure se trans‑ forme alors en 4 actions mineures, desquelles vous soustrayez les actions mineures qui restent à enlever. (compagnon, 132)",
      type: "negative",
      karmaCost: "8",
    },
    {
      key: "Dos douloureux",
      description:
        "Pour vous les coups subis sont souvent synonymes de maux de dos, entorses ou toute autre atteinte à votre mobilité. Chaque fois que vous êtes sous l’effet de modificateurs de dommages, vous subissez en plus l’état Entravé (même si vous disposez de moyens pour compenser les modificateurs de dommages, vous subissez tout de même l’état). Cet état disparaît en même temps que les modificateurs. (compagnon, 132)",
      type: "negative",
      karmaCost: "12",
    },
    {
    ...
    },
    {
      ...
      description:
        "Votre détachement tout professionnel rassure la plupart de vos clients, mais vous empêche de nouer des rela‑ tions plus profondes. Aucun de vos contacts ne peut avoir d’indice de Loyauté supérieur à 3. Quand vous inte‑ ragissez avec un client professionnel (comme un M. Johnson), bénéficiez d’une remise d’Atout de 1 sur tous vos tests d’Influence (Étiquette). (compagnon, 132)",
      type: "negative",
      karmaCost: "8",
    },
    {
      key: "Finesse",
      description:
        "Vous privilégiez toujours la subtilité pour atteindre vos objectifs et les stratégies à base de force brute vous mettent mal à l’aise. Vous ne pouvez pas gagner ou dépenser d’Atout lors d’actions susceptibles de générer un mo‑ dificateur de Pression. Si vous ne générez personnel‑ lement aucun modificateur de Pression positif, votre équipe bénéficie d’un modificateur de Pression de −1. (compagnon, 132)",
      type: "negative",
      karmaCost: "7",
    },
    {
      key: "Gourmet",
      description:
        "La nourriture vulgaire est une insulte à votre palais raffiné. Chaque fois que vous mangez de la nour‑ riture indigne d’un style de vie élevé ou plus, vous subissez l’état Nauséeux pendant une heure. Les fast foods, les plats instantanés, les produits Stuffer Shack et en général tout ce qui coûte moins de 20¥ par por‑ tion provoquera chez vous un profond inconfort. (compagnon, 132)",
      type: "negative",
      karmaCost: "5",
    },
    {
      key: "Indécis",
      description:
        "Vous avez du mal à prendre des décisions dans le feu de l’action. Vous devez bénéficier de quatre actions mineures par round de combat pour choisir ce trait. Effet en jeu : si vous ne disposez pas d’au moins 5 points d’Atout, vous ne pouvez pas échanger des actions mineures pour une seconde action majeure. (compagnon, 132)",
      type: "negative",
      karmaCost: "11",
    },
    {
    ...
    },
    {
      ...
      description:
        "La chance semble vous fuir, et même quand ce n’est pas le cas cela ne fait pas une grande différence. Vous ne pouvez gagner qu’un seul point d’Atout par tour. (compagnon, 133)",
      type: "negative",
      karmaCost: "25",
    },
    {
      key: "Nerveux",
      description:
        "Vous êtes toujours prêt pour les ennuis. Peut‑être un peu trop. Vous subissez un malus de −1 à la réserve de dés sur tous vos tests de Sang‑froid et d’Initiative. (compagnon, 133)",
      type: "negative",
      karmaCost: "5",
    },
    {
      key: "Non‑létal",
      description:
        "Même si vous devez vous battre, vous vous efforcez de ne pas tuer Vous ne pouvez pas gagner ou dépenser d’Atout quand vous utilisez un sort ou une attaque infligeant des dommages physiques. (compagnon, 133)",
      type: "negative",
      karmaCost: "5",
    },
    {
      key: "Poissard",
      description:
        "Les événements inattendus, improbables et malheureux sont votre quotidien. Chaque fois que vous obtenez une com‑ plication, elle compte comme un échec critique, peu importe le nombre de succès générés. (compagnon, 133)",
      type: "negative",
      karmaCost: "12",
    },
    {
    ...
    },
    {
      ...
      description:
        "On s’est trop joué de vous et vous êtes toujours à l’affût de signes de duperie. Vous ne pouvez gagner ou dépenser de l’Atout sur aucun test d’Influence (Étiquette ou Négociation) ou de Jauger les intentions. Aucun de vos contacts ne peut avoir un indice de Loyauté supé‑ rieur à 3. Si vous rejoignez un groupe magique, votre Loyauté ne peut pas dépasser 3. (compagnon, 133)",
      type: "negative",
      karmaCost: "10",
    },
    {
    ...
    },
    {
      ...
      description:
        "Quand vous êtes blessé, c’est toujours gravement. Chaque fois que vous subissez des dommages (quelle qu’en soit la source), cochez une case supplémentaire du même type (physique ou étourdissant). (compagnon, 133)",
      type: "negative",
      karmaCost: "15",
    },
    {
    ...
    },
    {
      key: "Tueur",
      description:
        "En combat vous préférez achever vos ennemis, pour éliminer les témoins et toute tentative de vengeance ultérieure. Vous ne pouvez pas gagner ou dépenser d’Atout quand vous utilisez un sort ou une attaque infligeant des dommages étourdissants. (compagnon, 134)",
      type: "negative",
      karmaCost: "4",
    },
    {
      ...
      description:
        "Vous êtes particulièrement sensible à une toxine commune. Quand vous y êtes soumis, augmentez sa virulence de 2. Dans ce cas précis, vous ne pouvez pas gagner ou dépenser d’Atout sur vos tests de Résistance aux toxines. (compagnon, 134)",
      type: "negative",
      karmaCost: "2",
    },
    {
    ...
    },
    {
      key: "On s’y fait",
      description:
        "De l’air que l’on inspire à l’eau que l’on boit, en passant par la terre avec laquelle jouent les enfants, Auburn regorge de toxines. Tous les marmots n’y survivent pas, mais ceux qui y parviennent deviennent plus résistants. Vous gagnez +1 en Constitution pour tout test de Résistance aux toxines. (seattleEmeraude, 42)",
      type: "positive",
      karmaCost: "5",
    },
    {
    ...
    },
    {
      ...
      description:
        "Êtes-vous abonnés à tous les journaux à scandales de la région? Avez-vous un contact vous confiant toutes les informations juteuses partagées en interne, qui vous retrouve régulièrement dans le kaf shop du coin? Quelle que soit la manière dont vous obtenez vos tuyaux, vous connaissez tout le monde en ville, tout comme leurs secrets. Ces quelques informations peuvent vous rapporter de l’argent ou vous permettre d’éviter bien des mésaventures. Vous obtenez une remise d’Atout de 1 lors des tests de Perception visant à reconnaître un individu et à distinguer les déguisements et impostures. Vous obtenez également les compétences de connaissances Potins de célébrités et Actualités. (seattleEmeraude, 80)",
      type: "positive",
      karmaCost: "10",
    },
    {
    ...
    },
    {
      ...
      description:
        "Vous avez vécu si longtemps sur les îles, que nager est comme une seconde nature pour vous. Votre vitesse de nage augmente de 1 mètre à chaque niveau de ce trait (maximum 2 mètres). (seattleEmeraude, 121)",
      type: "positive",
      karmaCost: "5",
    },
    {
    ...
    },
    {
      ...
      description:
        "Vous êtes rapide, mais encore plus quand vous avez quelqu’un à battre… ou à rattraper. Quand vous êtes engagé dans une course ou une poursuite, gagnez un point d’Atout au début de chaque round. Cet Atout ne peut alimenter que votre réserve de course-poursuite (voir p. 175). (tombeauOuvert, 167)",
      type: "positive",
      karmaCost: "8",
    },
    {
    ...
    },
    {
      ...
      description:
        "Une partie de vous ne vous fait jamais défaut; quand vous vous reposez dessus, vous vous en tirez toujours. Choisissez un de ces attributs: Constitution, Agilité, Réaction, Force, Volonté, Intuition ou Charisme. Quand vous effectuez un test basé sur celui-ci, bénéficiez d’une remise d’Atout de 1 à moins que votre Score Offensif ne vous accorde déjà un gain d’Atout. Vous ne pouvez acquérir ce trait qu’une seule fois. Il est incompatible avec Esprit analytique. Si vous possédez le trait Esprit analytique, vous ne pouvez pas prendre Maîtrise d’attribut. Si vous possédez le trait Maîtrise d’attribut, vous ne pouvez pas prendre Esprit analytique. (tombeauOuvert, 167)",
      type: "positive",
      karmaCost: "8",
    },
    {
    ...
    },
    {
      ...
      description:
        "Vous avez une action spéciale, que vous répétez encore et encore pour une simple raison: elle fonctionne à tous les coups. Et aussi, elle pète la classe. Du coup, ça fait deux raisons.  (tombeauOuvert, 167)",
      type: "positive",
      karmaCost: "4",
    },
    {
      key: "Outsider",
      description:
        "Vous n’êtes pas un chef de peloton. Être à la traîne vous motive à donner le meilleur de vous-même. Ou à partir dans une gerbe de flammes. Dans une poursuite, à chaque fois que quelqu’un bénéficie d’une position avantageuse par rapport à vous (voir p. 175), ajoutez un dé libre à tous vos tests de Pilotage. (tombeauOuvert, 168)",
      type: "positive",
      karmaCost: "7",
    },
    {
    ...
    },
    {
      key: "Toujours prêt",
      description:
        "Quand vous êtes sur la route (ou dans tout autre type de transport), vous êtes toujours à l’affût et prêt à engager une course-poursuite. Quand votre réserve de course-poursuite (voir p. 175) devient disponible, elle contient 1 point d’Atout par niveau (limité à la taille de votre réserve). (tombeauOuvert, 170)",
      type: "positive",
      karmaCost: "8",
    },
    {
    ...
    },
    {
      ...
      description:
        "Il y a toujours quelqu’un pour remarquer quand vous faites quelque chose de mal sur la route. Et ce ne sont jamais les bonnes personnes. Quand vous conduisez de manière dangereuse ou chaotique (à la discrétion du maître de jeu), lancez deux dés. Si vous obtenez 2 succès, la police locale vous repère. (tombeauOuvert, 170)",
      type: "negative",
      karmaCost: "8",
    },
    {
      ...
      description:
        "Pour faire simple : vous détonez, peu importe où vous allez. Vous ne pouvez ni gagner ni dépenser d’Atout lors des tests de Furtivité. (tombeauOuvert, 170)",
      type: "negative",
      karmaCost: "7",
    },
    {
      key: "Danger public",
      description:
        "Vous savez, cette histoire de conduite, là… peut-être que vous n’êtes pas fait pour ça. Ce n’est pas que vous êtes mauvais, c’est juste que quand vous êtes au volant, même les cocatrix s’abstiennent de traverser. –2 à la réserve de dés sur tous les tests d’accident. (tombeauOuvert, 170)",
      type: "negative",
      karmaCost: "4",
    },
    {
      key: "Distrait",
      description:
        "Vous avez beau essayer de vous concentrer et de garder les yeux grands ouverts, les gens arrivent toujours à échapper à votre vigilance. Vous ne pouvez ni gagner ni dépenser d’Atout lors des tests de Perception opposés à la Furtivité d’un adversaire. (tombeauOuvert, 170)",
      type: "negative",
      karmaCost: "5",
    },
    {
    ...
    },
    {
      ...
      description:
        "C’est peut-être de la malchance, ou alors c’est que vous n’arrêtez pas de cliquer sur les mauvais liens matriciels, mais vos firewalls sont de vraies passoires. Quand vous devez faire un test en utilisant le Firewall d’un appareil, votre adversaire gagne un point d’Atout. (tombeauOuvert, 171)",
      type: "negative",
      karmaCost: "3",
    },
    {
      ...
      description:
        "Conduire, c’est le pied… du moins quand vous n’êtes pas dans le véhicule. Tous ces mouvements, c’est franchement déstabilisant. Le pilotage à distance, il n’y a que ça de vrai. Vous ne pouvez pas gagner ni dépenser d’Atout quand vous pilotez un véhicule en étant physiquement présent à l’intérieur. (tombeauOuvert, 171)",
      type: "negative",
      karmaCost: "12",
    },
    {
    ...
    },
    {
      ...
      description:
        "Quand les choses partent en sucette, vous avez plus de mal à tirer votre épingle du jeu. Quand vous obtenez une complication ou un échec critique, vous ne pouvez pas influencer le résultat en dépensant de l’Atout. (tombeauOuvert, 171)",
      type: "negative",
      karmaCost: "3",
    },
    {
    ...
    },
    {
      key: "rEVOlutionnaire",
      description:
        "Vous êtes familier avec le fonctionnement d’Evo et avez manié assez de ses prototypes pour savoir comment les faire fonctionner sans problème. Lorsque le possesseur de ce trait utilise une arme rEVOlution Arms (Feu Nourri, p. 36), il peut choisir de ne pas lancer le Dé libre. (jeuxPouvoir, 64)",
      type: "positive",
      karmaCost: "10",
    },
    {
      ...
      description:
        "Vos relations chez Evo font de vous un bon candidat potentiel quand elle veut tester un nouvel équipement sur le terrain. Avoir ses entrées chez Evo vous permet d’accepter ces missions de test lucratives (et dangereuses). Ce trait ouvre la possibilité pour Evo de proposer du matériel à tester au personnage. Les détails sont à la discrétion du maître de jeu, mais devraient toujours s’accompagner de défaillances ou de problèmes potentiels. (jeuxPouvoir, 64)",
      type: "positive",
      karmaCost: "4",
    },
    {
      key: "PIHpeauteur",
      description:
        "Vous maîtrisez le système d’évaluation du Persona interne d’Horizon et pouvez le manipuler à partir de n’importe quel faux SIN de la corpo. Quand vous utilisez un SIN Horizon sur une propriété de la corpo, vous gagnez un point d’Atout à chaque interaction sociale donnant lieu à au moins un test. (jeuxPouvoir, 77)",
      type: "positive",
      karmaCost: "6",
    },
    {
      ...
      description:
        "Soit vous êtes trop magnifique pour qu’on vous frappe, soit votre langue est si acérée qu’elle désamorce toute violence. Votre Score Défensif est basé sur votre Charisme plutôt que sur votre Constitution. (jeuxPouvoir, 77)",
      type: "positive",
      karmaCost: "12",
    },
    {
    ...
    },
    {
      key: "Humain 2.0",
      description:
        "Grâce aux manipulations génétiques et à la reproduction sélective, Shiawase a réussi à améliorer quelque peu le génome humain. Il ne tient qu’à vous de découvrir votre plein potentiel. Vos limites raciales en Charisme et en Volonté augmentent de 1. Vous ne pouvez pas utiliser la magie ni la Résonance. (jeuxPouvoir, 138)",
      type: "positive",
      karmaCost: "25",
    },
    {
    ...
    },
    {
      ...
      description:
        "Votre spécialisation en religion Shinto vous confère une affinité particulière avec les esprits liés à cette tradition. Vous obtenez un bonus de +1 dé à vos tests d’Invocation au sein d’un sanctuaire Shinto. Les esprits corrompus vous privilégieront toujours à d’autres cibles. (jeuxPouvoir, 138)",
      type: "positive",
      karmaCost: "2",
    },
    {

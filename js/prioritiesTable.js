...
function selectPriority(cell, categorie, priority) {
    ...
    if (categorie === "metatypes") generateButtons("metatypeTitle", "metatypeButtons", getMetatypesForPriority(actualPriority), "metatype", actualPriority); // Utiliser la priorité actuelle
    if (categorie === "magicOrResonance") generateButtons("specialTitle", "specialButtons", ["adept", "mysticAdept", "fullMagician", "aspectedMagician", "technomancer"], "special", actualPriority); // Utiliser la priorité actuelle
  }
